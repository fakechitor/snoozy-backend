...
Модуль `snoozy-alarm` отвечает за:

- создание и управление своими будильниками
- выдачу прав другим пользователям на удалённое взаимодействие с будильниками
- удалённый запуск, включение и выключение будильников
- просмотр истории действий над будильниками
- хранение признака, был ли будильник проспан
- настройку повторения будильника по конкретным дням недели
