...
### `PATCH /{alarmId}` — Обновить будильник
...
### `DELETE /{alarmId}` — Удалить будильник
...
### `POST /permissions` — Выдать право пользователю
...
### `GET /permissions` — Получить список выданных прав
...
### `POST /{alarmId}/trigger` — Удалённо запустить будильник
...
### `POST /{alarmId}/enable` — Включить чужой будильник
...
### `POST /{alarmId}/disable` — Выключить чужой будильник
...
### `GET /actions/incoming` — История действий над своими будильниками
